...
var app = (function () {
    ...
    /* Components/LoginComponent.svelte generated by Svelte v3.49.0 */

    const { console: console_1 } = globals;
    const file$2 = "Components/LoginComponent.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			small = element("small");
    			t3 = text(/*error*/ ctx[1]);
    			attr_dev(input, "class", "form-control svelte-ugp6dj");
    			attr_dev(input, "id", "username");
    			attr_dev(input, "placeholder", "Username");
    			add_location(input, file$2, 27, 8, 586);
    			attr_dev(div0, "class", "mb-3");
    			add_location(div0, file$2, 26, 4, 559);
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "btn btn-primary");
    			add_location(button, file$2, 30, 4, 692);
    			add_location(small, file$2, 32, 8, 811);
    			attr_dev(div1, "id", "error_message");
    			attr_dev(div1, "class", "text-danger");
    			add_location(div1, file$2, 31, 4, 758);
    			attr_dev(form, "class", "flex mx-auto col-6");
    			add_location(form, file$2, 24, 0, 487);
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	async function login() {
    		...
    		if (user) {
    			...
    			if (error) $$invalidate(1, error = '');
    		} else {
    			$$invalidate(1, error = 'Incorrect username');
    	...
    	return [username, error, login, input_input_handler];
    }
    ...
    /* Components/AfterLogin.svelte generated by Svelte v3.49.0 */

    const file$1 = "Components/AfterLogin.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			main.textContent = "User is logged in.";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			if_block.c();
    			attr_dev(h1, "class", "svelte-ebgiw4");
    			add_location(h1, file, 7, 1, 191);
    			attr_dev(meta0, "charset", "UTF-8");
    			add_location(meta0, file, 8, 1, 210);
    			attr_dev(meta1, "name", "viewport");
    			attr_dev(meta1, "content", "width=device-width, initial-scale=1.0");
    			add_location(meta1, file, 9, 1, 234);
    			attr_dev(main, "class", "svelte-ebgiw4");
    			add_location(main, file, 6, 0, 183);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(main, h1);
    			append_dev(main, t1);
    			append_dev(main, meta0);
    			append_dev(main, t2);
    			append_dev(main, meta1);
    			append_dev(main, t3);
